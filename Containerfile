...
CMD make FORCE=1 V=s image FILES="files" PACKAGES="libmosquitto-nossl collectd collectd-mod-mqtt collectd-mod-memory collectd-mod-interface \
  collectd-mod-load collectd-mod-uptime collectd-mod-ping collectd-mod-cpu iperf3 tcpdump-mini unbound-daemon libunbound libudev-zero \

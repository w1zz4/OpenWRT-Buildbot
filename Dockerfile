...
CMD make FORCE=1 V=s image FILES="files" PACKAGES="cloudflared luci-app-cloudflared collectd collectd-mod-mqtt collectd-mod-memory collectd-mod-interface \
